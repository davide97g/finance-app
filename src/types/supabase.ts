    ...
    Tables: {
      ...
      user_settings: {
        Row: {
          ...
          category_sorting_days: number | null;
          category_sorting_enabled: boolean | null;
          category_sorting_strategy: string | null;
      ...
      category_usage_stats: {
        ...
        Relationships: [
          {
            foreignKeyName: "category_usage_stats_user_id_fkey";
            columns: ["user_id"];
            isOneToOne: false;
            referencedRelation: "users";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "category_usage_stats_category_id_fkey";
            columns: ["category_id"];
            isOneToOne: false;
            referencedRelation: "categories";
            referencedColumns: ["id"];
